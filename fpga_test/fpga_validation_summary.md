...
This validation is limited to the decode-attention INT8 QK dot-product primitive. The FPGA does not implement full KV-cache management, does not run Gemma 3 1B, and does not provide end-to-end ONNX Runtime comparison evidence.
