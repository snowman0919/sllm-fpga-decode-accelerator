...
set project_name de10_lite_decode_matvec
set revision_name de10_lite_decode_matvec
set top_level DecodeMatVecDemoTop
set device_name 10M50DAF484C7G
set generated_dir [file join $project_dir generated_verilog]
set sdc_file [file join $project_dir de10_lite_decode_matvec.sdc]
...
set required_files [list \
  ...
  [file join $generated_dir DecodeMatVecDemoTop.v] \
  $sdc_file]
