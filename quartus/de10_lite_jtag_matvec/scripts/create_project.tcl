...
set top_level JtagDecodeMatVecRegTop
...
set verilog_files [list \
  ...
  [file join $generated_dir DecodeMatVecRegBank.v] \
  [file join $generated_dir HexDisplay.v] \
  [file join $generated_dir JtagDecodeMatVecRegTop.v]]
...
post_message -type warning "This project only compiles the exported register top. A board-ready JTAG offload system still needs Platform Designer JTAG-to-Avalon Master integration."
