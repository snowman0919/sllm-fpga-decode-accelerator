...
| --- | --- | --- | --- |
| mlp_projection | 14976 | 21320.468 | 59.61% |
| lm_head | 192 | 10585.135 | 29.59% |
| attention_qkv_projection | 14976 | 1695.143 | 4.74% |
| attention_output_projection | 4992 | 1250.607 | 3.50% |
| attention_v_weighted_sum | 4992 | 913.110 | 2.55% |
| unknown | 384 | 2.848 | 0.01% |
...
| --- | --- | --- | --- | --- |
| decode | mlp_projection | 14040 | 13538.396 | 63.11% |
| decode | lm_head | 180 | 5948.898 | 27.73% |
| decode | attention_qkv_projection | 14040 | 1101.946 | 5.14% |
| decode | attention_output_projection | 4680 | 723.956 | 3.37% |
| decode | attention_v_weighted_sum | 4680 | 138.114 | 0.64% |
| decode | unknown | 360 | 2.336 | 0.01% |
| decode | attention_qk_score | 0 | 0.000 | 0.00% |
| prefill | mlp_projection | 936 | 7782.072 | 54.37% |
| prefill | lm_head | 12 | 4636.237 | 32.39% |
| prefill | attention_v_weighted_sum | 312 | 774.996 | 5.41% |
| prefill | attention_qkv_projection | 936 | 593.197 | 4.14% |
| prefill | attention_output_projection | 312 | 526.651 | 3.68% |
| prefill | unknown | 24 | 0.512 | 0.00% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| lm_head | prefill | 2048 | 0 | /lm_head/MatMul | 3 | 2605.331 | 31.97% |
| lm_head | prefill | 1024 | 0 | /lm_head/MatMul | 3 | 1191.334 | 32.12% |
| lm_head | decode | 1024 | 8 | /lm_head/MatMul | 24 | 806.086 | 28.18% |
| lm_head | decode | 2048 | 8 | /lm_head/MatMul | 24 | 796.370 | 26.72% |
| lm_head | decode | 512 | 8 | /lm_head/MatMul | 24 | 786.158 | 28.85% |
| lm_head | decode | 128 | 8 | /lm_head/MatMul | 24 | 781.567 | 28.45% |
| lm_head | prefill | 512 | 0 | /lm_head/MatMul | 3 | 612.010 | 32.97% |
| lm_head | decode | 2048 | 4 | /lm_head/MatMul | 12 | 399.353 | 27.26% |
| lm_head | decode | 128 | 4 | /lm_head/MatMul | 12 | 399.311 | 26.11% |
| lm_head | decode | 1024 | 4 | /lm_head/MatMul | 12 | 395.180 | 28.08% |
| lm_head | decode | 512 | 4 | /lm_head/MatMul | 12 | 392.537 | 28.32% |
| lm_head | prefill | 128 | 0 | /lm_head/MatMul | 3 | 227.562 | 38.01% |
| lm_head | decode | 1024 | 2 | /lm_head/MatMul | 6 | 198.307 | 27.40% |
| lm_head | decode | 2048 | 2 | /lm_head/MatMul | 6 | 198.067 | 26.83% |
| lm_head | decode | 512 | 2 | /lm_head/MatMul | 6 | 197.607 | 27.93% |
| lm_head | decode | 128 | 2 | /lm_head/MatMul | 6 | 194.654 | 28.38% |
| lm_head | decode | 2048 | 1 | /lm_head/MatMul | 3 | 108.094 | 26.35% |
| lm_head | decode | 512 | 1 | /lm_head/MatMul | 3 | 100.297 | 27.94% |
| lm_head | decode | 1024 | 1 | /lm_head/MatMul | 3 | 98.345 | 26.02% |
| lm_head | decode | 128 | 1 | /lm_head/MatMul | 3 | 96.965 | 27.67% |
...
- attention/MLP/lm_head projection으로 분류된 일반 MatVec/MatMul 계열 합계는 전체 MatMul 시간의 97.44%이다.
