...
이하 표의 출처 열은 지면 폭을 줄이기 위해 `assets/` 기준 CSV 약어로 표기한다.
...
![그림 2. ONNX Runtime MatMul phase 비중](assets/f02.png)
...
![그림 3. Long-decode ORT CPU MatMul share](assets/f03.png)

그림 3. Decode step 증가에 따른 ONNX Runtime CPUExecutionProvider traced decode node time 중 MatMul 비중.

![그림 4. Long-decode ORT CPU shape-related op share](assets/f04.png)
...
![그림 5. MatMul category breakdown](assets/f05.png)
...
![그림 6. FPGA Decode tiled MatVec/MatMul accelerator architecture](assets/f06.png)
...
![그림 7. JTAG vs optimized FPGA latency interpretation](assets/f07.png)
...
![그림 8. ORT vs FPGA measured/projected latency decomposition](assets/f08.png)
