...
| 항목 | 값 | 출처 |
| --- | ---: | --- |
| ONNX graph node 수 | 7837 | `paper_assets/tables/onnx_operator_histogram.csv` |
| ONNX MatMul node 수 | 237 | `paper_assets/tables/onnx_operator_histogram.csv` |
| cache input 수 | 52 | `paper_assets/tables/onnx_graph_io_summary.csv` |
| cache output 수 | 52 | `paper_assets/tables/onnx_graph_io_summary.csv` |
| decode cache reuse ready | True | `paper_assets/tables/onnx_graph_io_summary.csv` |
...
| 항목 | 설정 또는 산출물 | 출처 |
| --- | --- | --- |
| Runtime provider | ONNX Runtime `CPUExecutionProvider` | `paper_assets/tables/ort_provider_summary.csv` |
...
| Runs / warmup | 3 / 1 | `paper_assets/tables/ort_session_summary.csv` |
...
| Long-decode runs / warmup | 1 / 0 | `paper_assets/tables/ort_long_decode_sweep_latency.csv` |
...
| --- | ---: | ---: | ---: | --- |
| prefill + decode trace 수집 node 시간 | 37.918 s | 56.168 s | 67.5% | `paper_assets/tables/ort_operator_share_by_context.csv` |
| prefill trace 수집 node 시간 | 14.711 s | 27.539 s | 53.4% | `paper_assets/tables/ort_operator_share_by_context.csv` |
| decode trace 수집 node 시간 | 23.207 s | 28.629 s | 81.1% | `paper_assets/tables/ort_operator_share_by_context.csv` |
...
그림 2. ONNX Runtime trace 수집 node 시간에서 MatMul이 차지하는 비중. 수치는 `paper_assets/tables/ort_operator_share_by_context.csv`의 기존 ORT profiling 해석값을 시각화한 것이다.
...
| `attention_qk_score` | 0 | 0.000 ms | 0.00% | `paper_assets/tables/ort_matmul_category_by_context.csv` |
| `mlp_projection + lm_head` | 15168 | 33709.830 ms | 88.90% | `paper_assets/tables/ort_matmul_category_by_context.csv` |
...
| `.sof` SHA-256 | `40a4f84167d2fd75972ea33684ec949b6c22e61057f1c134dd5bd4b936ef4a84` | `paper_assets/tables/quartus_resource_timing_summary.csv` |
...
| 항목 | 값 | 출처 |
| --- | ---: | --- |
| pass_count / fail_count | 20 / 0 | `paper_assets/tables/fpga_jtag_primitive_benchmark.csv` |
| reference / result | `-271 239 287 797` / `-271 239 287 797` | `paper_assets/tables/fpga_jtag_primitive_benchmark.csv` |
| `COMPUTE_CYCLES` mean/p50/p95 | 65.0 / 65.0 / 65.0 cycles | `paper_assets/tables/fpga_jtag_cycle_counter_summary.csv` |
| compute time mean/p50/p95 | 1.3 / 1.3 / 1.3 us @ 50 MHz | `paper_assets/tables/fpga_jtag_cycle_counter_summary.csv` |
| JTAG total latency mean/p50/p95 | 7720.85016 / 7720.45115 / 7748.84833 ms | `paper_assets/tables/fpga_jtag_primitive_benchmark.csv` |
| JTAG latency 해석 | host-tool invocation overhead, not FPGA compute latency | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
...
| --- | --- | --- | --- | ---: | --- | --- |
| CPU NumPy primitive | measured | host NumPy int32 | true | 0.028922 ms | measured CPU reference primitive only | `paper_assets/tables/onnx_runtime_aligned_micrograph_baseline.csv` |
| ONNX Runtime MatVec micrograph | measured | CPUExecutionProvider | true | 0.063135 ms | measured ONNX Runtime micrograph baseline only; float32 equivalent | `paper_assets/tables/onnx_runtime_aligned_micrograph_baseline.csv` |
| ONNX Runtime MatMulInteger micrograph | measured | CPUExecutionProvider | true | 0.013012 ms | measured ONNX Runtime integer micrograph baseline only | `paper_assets/tables/onnx_runtime_integer_micrograph_baseline.csv` |
| FPGA JTAG register offload | measured | JTAG-to-Avalon | true | 7720.85016 ms total invocation mean | measured correctness and invocation overhead, not acceleration | `paper_assets/tables/fpga_jtag_primitive_benchmark.csv` |
| FPGA internal Decode MatVec | measured board cycle counter | cycle counter register | true | 65 cycles, 1.3 us at 50 MHz | primitive internal compute latency only | `paper_assets/tables/fpga_jtag_cycle_counter_summary.csv` |
...
| --- | --- | --- | ---: | --- | --- |
| CPU NumPy primitive | measured | host NumPy int32 | 0.028922 ms | measured host-side primitive baseline | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
| ONNX Runtime MatVec micrograph | measured | CPUExecutionProvider | 0.063135 ms | measured ONNX Runtime micrograph baseline only | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
| ONNX Runtime MatMulInteger micrograph | measured | CPUExecutionProvider | 0.013012 ms | measured integer micrograph baseline only | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
| FPGA internal Decode MatVec | board measured | cycle counter register | 0.001300 ms | primitive internal compute latency only; not end-to-end speedup | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
| FPGA JTAG total invocation | measured | USB-Blaster JTAG / System Console | 7720.850160 ms | invocation overhead; not compute latency | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
| FPGA optimized interface | projected | ideal register batch nominal | 0.005142768 ms | projected estimate, not measured board latency; Fmax from latest Quartus summary | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
