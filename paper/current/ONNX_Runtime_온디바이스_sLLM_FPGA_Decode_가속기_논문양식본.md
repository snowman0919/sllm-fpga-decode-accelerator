...
| ONNX Runtime MatMulInteger micrograph | measured | CPUExecutionProvider | true | 0.043146 ms | measured ONNX Runtime integer micrograph baseline only | `paper_assets/tables/onnx_runtime_integer_micrograph_baseline.csv` |
...
| FPGA internal compute cycles | measured board cycle counter | cycle counter register | true | 65 cycles, 1.3 us at 50 MHz | primitive internal compute latency only | `paper_assets/tables/fpga_jtag_cycle_counter_summary.csv` |
...
| ONNX Runtime MatMulInteger micrograph | measured | CPUExecutionProvider | 0.043146 ms | measured integer micrograph baseline only | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
| FPGA internal compute cycles | measured | cycle counter register | 0.001300 ms | primitive internal compute latency only; not end-to-end speedup | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
