...
| FPGA JTAG register offload | measured | JTAG-to-Avalon | true | 7756.72185 ms total invocation mean | measured correctness and invocation overhead, not acceleration | `paper_assets/tables/fpga_jtag_primitive_benchmark.csv` |
...
| FPGA JTAG total invocation | measured | USB-Blaster JTAG / System Console | 7756.721850 ms | invocation overhead; not compute latency | `paper_assets/tables/ort_vs_fpga_measured_and_projected_comparison.csv` |
